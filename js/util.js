...
const I18N = {
  en:{
    ...
    "gacha.rates":p=>`Rates: ${p}\n*10th card of a 10-pull is SR+`,
    ...
    "voice.gacha":"Gacha",
    "live.title":"School Idol Show","live.small":n=>`SCHOOL IDOL SHOW — ${n} CHARTS`,
    "live.appeal":"Appeal ","live.edit":"⇄ Edit Unit","live.speed":"Speed",
    "live.support":n=>`(includes +${n} from the rest of your collection)`,
    "live.totalScore":"TOTAL SCORE","live.cleared":n=>`${n} charts cleared`,
    "live.help":"Keys S・D・F・J・K・L, or tap the lanes. Green flicks accept a tap; hold a key over yellow trace notes.",
    "live.helpSp":"Press Space (or tap SPECIAL) once the gauge is full to activate Special Appeal — a ×1.5 score boost for 8 seconds.",
    "live.pickerPre":"Unit (","live.pickerPost":"/6)","live.done":"Done",
    "live.idolArt":"✦ Idolized Art",
  ...
  ja:{
    ...
    "voice.gacha":"ガチャ",
    "live.title":"スクールアイドルショウ","live.small":n=>`SCHOOL IDOL SHOW — ${n}曲`,
    "live.appeal":"アピール ","live.edit":"⇄ 編成","live.speed":"スピード",
    "live.support":n=>`（その他の手持ちカードより +${n} を含む）`,
    "live.totalScore":"トータルスコア","live.cleared":n=>`${n} 譜面クリア`,
    "live.help":"S・D・F・J・K・L キー、またはレーンをタップ。緑フリックはタップでOK、黄トレースノーツはキーを押しっぱなしで拾えます。",
    "live.helpSp":"ゲージが満タンになったらスペースキー（またはSPECIALボタン）でスペシャルアピール発動 — 8秒間スコアが1.5倍に。",
    "live.pickerPre":"ユニット編成（","live.pickerPost":"/6）","live.done":"決定",
    "live.idolArt":"✦ 覚醒アート",
